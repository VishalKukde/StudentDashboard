            ...
            <div className="grid gap-4 lg:grid-cols-2 xl:grid-cols-3">
              {courses.map((course) => (
                <button
                  ...
                  className={`rounded-[1.75rem] border p-5 text-left transition hover:-translate-y-0.5 ${
                    selectedCourse?._id === course._id ? "border-sky-300 bg-sky-50 shadow-[0_12px_30px_rgba(37,99,235,0.08)]" : "border-slate-200 bg-white hover:border-sky-200"
                  }`}
                >
